    ...
    return(
        <div>
                <Link href={`/slide/${previousSlide}`}>
                  <Image className={styles.backButton} src={iconBackButton} width={17.3} height={16} alt="back button icon"/>
                </Link>
                
                <Link href={`/slide/${nextSlide}`}>
                <Image className={styles.nextButton} src={iconNextButton} width={17.3} height={16} alt="next button icon"/>
                </Link>
            </div>
    );
}